...
export default function GymnasticsQuizPage() {
  const [quizStarted, setQuizStarted] = useState(false);
  const [result, setResult] = useState<QuizResult | null>(null);

  const quiz = quizzes.find(q => q.subjectId === 'gymnastics')!;
    ...
    return (
      <div className="min-h-screen p-8">
        <div className="max-w-4xl mx-auto">
          <Link href="/subjects/gymnastics" className="inline-block mb-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-pink-400 to-pink-600 rounded-3xl p-12 shadow-2xl text-white text-center mb-8"
          >
            <div className="text-8xl mb-6">🤸</div>
            <h1 className="text-5xl font-bold mb-4">Gymnastics Quiz</h1>
            <p className="text-2xl mb-2">Ready to test your health knowledge?</p>
  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-pink-400 to-pink-600 rounded-3xl p-8 shadow-2xl text-white text-center mb-8">
          <h1 className="text-4xl font-bold">🤸 Gymnastics Quiz</h1>
        </div>

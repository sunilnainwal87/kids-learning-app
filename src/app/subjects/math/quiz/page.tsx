...
export default function MathQuizPage() {
  ...
  const quiz = quizzes.find(q => q.subjectId === 'math')!;
    ...
    return (
      <div className="min-h-screen p-8">
        <div className="max-w-4xl mx-auto">
          <Link href="/subjects/math" className="inline-block mb-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-3xl p-12 shadow-2xl text-white text-center mb-8"
          >
            <div className="text-8xl mb-6">🔢</div>
            <h1 className="text-5xl font-bold mb-4">Math Quiz</h1>
            <p className="text-2xl mb-2">Ready to test your math skills?</p>
  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-3xl p-8 shadow-2xl text-white text-center mb-8">
          <h1 className="text-4xl font-bold">🔢 Math Quiz</h1>
        </div>

...
export default function FrenchPage() {
  const lessons = [
    { id: 1, title: 'Basic Greetings', difficulty: 'easy', icon: '👋' },
    { id: 2, title: 'Numbers 1-20', difficulty: 'easy', icon: '🔢' },
    { id: 3, title: 'Colors & Shapes', difficulty: 'easy', icon: '🎨' },
    { id: 4, title: 'Animals', difficulty: 'medium', icon: '🐾' },
  ];
  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Header */}
        <header className="text-center mb-12 bg-gradient-to-br from-purple-400 to-purple-600 rounded-3xl p-12 shadow-2xl">
          <div className="text-8xl mb-4">🇫🇷</div>
          <h1 className="text-5xl font-bold text-white mb-4">French Fun!</h1>
        ...
        {/* Quiz Button */}
        <Link href="/subjects/french/quiz">
          <motion.div
          ...
          >
            <div className="flex items-center gap-4 text-white">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold mb-2">Take French Quiz</h3>

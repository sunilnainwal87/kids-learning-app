...
export default function EnglishQuizPage() {
  ...
  const quiz = quizzes.find(q => q.subjectId === 'english')!;
    ...
    return (
      <div className="min-h-screen p-8">
        <div className="max-w-4xl mx-auto">
          <Link href="/subjects/english" className="inline-block mb-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-red-400 to-red-600 rounded-3xl p-12 shadow-2xl text-white text-center mb-8"
          >
            <div className="text-8xl mb-6">📚</div>
            <h1 className="text-5xl font-bold mb-4">English Quiz</h1>
            <p className="text-2xl mb-2">Ready to test your English skills?</p>
  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-red-400 to-red-600 rounded-3xl p-8 shadow-2xl text-white text-center mb-8">
          <h1 className="text-4xl font-bold">📚 English Quiz</h1>
        </div>
